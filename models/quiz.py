...
class MultiChoiceQuiz():
    def __init__(self):
        ...
        credentials: json = json.load(open(".venv/model_credentials.json", "r")) # TODO Fix file path by release
        self.MODEL_API_KEY = credentials["GROQ_API_KEY"]
        
        self.client = Groq(api_key=self.MODEL_API_KEY)

        self.MODEL = "meta-llama/llama-4-scout-17b-16e-instruct"
    
    
    def generate_quiz(self, quiz_context: str) -> str:
        prompt = f"""
    ...
    def get_schema(self) -> str:
        schema = json.load(open("models/mutli-choice-quiz-schema.json", "r"))
    ...
    def get_system_prompt(self) -> str:
        ...
        system_prompt = f"""
            ...
            Your job is to generate 10 multiple choice questions based on the provided JSON schema. The output should be
...
def main():
    ...
    print(quiz_generator.generate_quiz(text))
